...
var assertFileExists = function(infile){
	...
	process.exit(1); //http://nodejs.org/api/process.html#process.html#process_process_exit_code
    }
...
var cheerioHtmlFile = function(htmlfile,htmlstring){
...
var checkHtmlFile = function(htmlfile,checksfile,url){
    if(url== undefined){      
        ...
        $ = cheerioHtmlFile(htmlfile,getResp(url));
    }
...
if ( require.main == module){
    program
        ...
        .option('-u,--url <url>','url of required file')
        .parse(process.argv);    
